...
public class ShowResource {
    ...
    @PostMapping("/shows")
    @Timed
    public ResponseEntity<ShowDTO> createShow(@RequestBody ShowDTO showDTO) throws URISyntaxException {
    ...
    @PutMapping("/shows")
    @Timed
    public ResponseEntity<ShowDTO> updateShow(@RequestBody ShowDTO showDTO) throws URISyntaxException {
