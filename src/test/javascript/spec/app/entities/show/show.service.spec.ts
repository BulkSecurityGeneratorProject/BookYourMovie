...
import { IShow, Show } from 'app/shared/model/show.model';
...
describe('Service Tests', () => {
    describe('Show Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Show(0, currentDate);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Show', async () => {
                const returnedFromService = Object.assign(
                    {
                        time: currentDate.format(DATE_TIME_FORMAT)
                    },
